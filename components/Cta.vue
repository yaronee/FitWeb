<template>
   <div class="bg-neutral-900">
      <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        <div class="relative isolate overflow-hidden bg-lime-400 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 class="text-4xl font-bold mb-8 text-white">
              Prêt à te muscler sans te casser le moral ?
            </h2>
            <p class="mt-6 text-lg text-white opacity-80">
          ...
          <div class="relative mt-16 h-80 lg:mt-8">
            <img class="absolute left-0 top-0 w-[57rem] max-w-none" src="/img/tibo4.png" alt="Max en action" width="1824" height="1080" />
          </div>
        </div>
      </div>
    </div>
